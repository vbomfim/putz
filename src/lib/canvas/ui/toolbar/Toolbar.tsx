...
export function Toolbar({
  ...
  const scroll = useCallback((dir: "up" | "down") => {
    ...
    if (!el) return;
    el.scrollBy({
      top: dir === "up" ? -BUTTON_SIZE * 2 : BUTTON_SIZE * 2,
      behavior: "smooth",
    });
  }, []);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <StyleIndicator
          style={lastUsedStyle}
          isTransparentFill={isTransparentFill}
        />
          ...
          <>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 6,
                cursor: "pointer",
                backgroundColor: isStencilPaletteOpen
                  ? "#4A90D9"
                  : "transparent",
                color: isStencilPaletteOpen
                  ? "#ffffff"
  ...
  return (
    <div
      ...
      style={{
        ...
        borderWidth: 3,
        borderStyle: "solid",
        backgroundColor: isTransparentFill
          ? "transparent"
...
function GroupActions() {
  ...
  const canUngroup =
    firstParent &&
    selectedArray.every((id) => expressions[id]?.parentId === firstParent);
  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => bringToFront(selectedArray)}
        style={btnStyle}
      >
      ...
      <button
        ...
        onClick={() => bringForward(selectedArray)}
        style={btnStyle}
      >
      ...
      <button
        ...
        onClick={() => sendBackward(selectedArray)}
        style={btnStyle}
      >
      ...
      <button
        ...
        onClick={() => sendToBack(selectedArray)}
        style={btnStyle}
      >
