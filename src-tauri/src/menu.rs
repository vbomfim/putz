...
pub fn build_menu(app: &AppHandle<Wry>) -> Result<tauri::menu::Menu<Wry>, tauri::Error> {
    let file_menu = SubmenuBuilder::new(app, "File")
        ...
        .separator()
        .item(&menu_item!(app, "menu-import-sessions", "Import Sessions..."))
        .item(&menu_item!(app, "menu-export-sessions", "Export Sessions..."))
        .separator()
        .item(&menu_item!(app, "menu-close-tab", "Close Tab", "CmdOrCtrl+Shift+W"))
    ...
    let view_menu = SubmenuBuilder::new(app, "View")
        ...
        .item(&menu_item!(app, "menu-toggle-broadcast", "Toggle Broadcast", "CmdOrCtrl+Shift+A"))
        .separator()
    ...
    let session_menu = SubmenuBuilder::new(app, "Session")
        ...
        .separator()
        .item(&menu_item!(app, "menu-session-manager", "Session Manager", "CmdOrCtrl+B"))
        .item(&menu_item!(app, "menu-credential-vault", "Credential Vault"))
        .item(&menu_item!(app, "menu-ssh-key-manager", "SSH Key Manager"))
        .separator()
        .item(&menu_item!(app, "menu-start-logging", "Start Logging", "CmdOrCtrl+Shift+L"))
    ...
    let window_menu = SubmenuBuilder::new(app, "Window")
        ...
        .item(&menu_item!(app, "menu-pop-out-tab", "Pop Out Tab", "CmdOrCtrl+Shift+P"))
        .separator()
        .item(&menu_item!(app, "menu-tile-horizontally", "Tile Horizontally"))
        .item(&menu_item!(app, "menu-tile-vertically", "Tile Vertically"))
        .item(&menu_item!(app, "menu-cascade", "Cascade"))
        .separator()
        .item(&menu_item!(app, "menu-next-tab", "Next Tab", "CmdOrCtrl+Tab"))
        .item(&menu_item!(app, "menu-previous-tab", "Previous Tab", "CmdOrCtrl+Shift+Tab"))
        .build()?;
    ...
    let help_menu = SubmenuBuilder::new(app, "Help")
        .item(&PredefinedMenuItem::about(app, Some("About Putz"), Some(about_metadata))?)
        .item(&menu_item!(app, "menu-documentation", "Documentation"))
        .item(&menu_item!(app, "menu-keyboard-shortcuts", "Keyboard Shortcuts"))
        .item(&menu_item!(app, "menu-check-updates", "Check for Updates"))
        .separator()
        .item(&menu_item!(app, "menu-report-issue", "Report Issue (GitHub)"))
        .build()?;
...
mod tests {
    ...
    fn menu_item_ids_are_valid_strings() {
        ...
        for id in ids {
            ...
            assert!(id.starts_with("menu-"), "Menu item ID should start with 'menu-'");
            assert!(
